<p align="center">
    API for the MooBee apps. Built with the MEN stack.
  </p>
</p>
...
To read the API documentation, please follow [this link](https://edisonabdiel.github.io/Moobee-server/public/documentation).
